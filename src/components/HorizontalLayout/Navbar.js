...
class Navbar extends Component {
    ...
    render() {
        return ( <React.Fragment >
            ...
            <BiDesktop > </BiDesktop> </strong> <span className = "ms-1" > {
            ...
            aria-expanded = "false" >
            <strong className = "me-2" >
            <BsFillBagFill > </BsFillBagFill> </strong> <span className = "ms-1" > {
                this.props.t("Job Pool")
            } </span> <div className = "arrow-down" > </div> </Link>
            ...
            role = "button" >
            <strong className = "me-2" >
            <BsCardHeading > </BsCardHeading> </strong> <span className = "ms-1" > {
                this.props.t("Questionaries")
            } </span> <div className = "arrow-down" > </div> </Link> {
                /* <div
            ...
            role = "button" >
            <strong className = "me-2" >
            <FiUsers > </FiUsers> </strong> <span className = "ms-1" > {
                this.props.t("Users")
            } </span> <div className = "arrow-down" > </div> </Link> <div className = {
            ...
            aria-expanded = "false" >
            <strong className = "me-2" >
            <GiAirBalloon > </GiAirBalloon> </strong> <span className = "ms-1" > {
                this.props.t("Brands")
            } </span> <div className = "arrow-down" > </div> </Link> <div className = {
                classname("dropdown-menu", {
            ...
            aria-expanded = "false" >
            <strong className = "me-2" >
            <BsBarChartFill > </BsBarChartFill> </strong> 
            <span className = "ms-1" > {
                this.props.t("Job Report")
            } </span> <div className = "arrow-down" > </div> </Link> < div className = {
                classname("dropdown-menu", {
                    show: this.state.extraState,
                })
            ...
            aria-expanded = "false" >
            <strong className = "me-2" >
            <MdOutlineSupervisorAccount > </MdOutlineSupervisorAccount> </strong> <span className = "ms-1" > {
            ...
            aria-expanded = "false" >
            <strong className = "me-2" >
            <FaHandsHelping > </FaHandsHelping> </strong> <span className = "ms-1" > {
                this.props.t("Sponsers")
            } </span> <div className = "arrow-down" > </div> </Link> <div className = {
                classname("dropdown-menu", {
                    show: this.state.extraState,
                })
            ...
            } </ul> </Collapse> </nav> </Container> </div> </React.Fragment>
        );
    }
}
