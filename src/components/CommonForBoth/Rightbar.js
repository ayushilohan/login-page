...
class RightSidebar extends Component {
    ...
    render() {
        return ( <React.Fragment >
            ...
            <i className = "mdi mdi-close noti-icon" > </i> </Link> <h5 className = "m-0" > Settings </h5> 
            </div>
            ...
            /> < Label htmlFor = "radioHorizontal" > Horizontal </Label> </div>
            ...
            id = "radio-title" >
            Layout Width </span> <Input type = "radio"
            id = "radioFluid"
            name = "radioWidth"
            value = "fluid"
            checked = {
                this.state.layoutWidth !== "boxed"
            }
            onChange = {
            ...
            /> <Label htmlFor = "radioBoxed" > Boxed </Label> </div> <hr className = "mt-1" />

            <div className = "radio-toolbar" >
            <span className = "mb-2 d-block"
            id = "radio-title" >
            Topbar Theme </span> <Input type = "radio"
            id = "radioThemeLight"
            name = "radioTheme"
            value = "light"
            checked = {
                this.state.topbarTheme === "light"
            }
            onChange = {
...

            {
                this.state.layoutType === "vertical" ? ( <React.Fragment >
                    ...
                    <span className = "mb-2 d-block"
                    id = "radio-title" >
                    Left Sidebar Type </span> <Input type = "radio"
                    id = "sidebarDefault"
                    name = "sidebarType"
                    value = "default"
                    checked = {
                    ...
                    value = "compact"
                    checked = {
                        this.state.sidebarType === "compact"
                    }
                    onChange = {
                        this.changeLeftSidebarType
                    }
                    ...
                    value = "icon"
                    checked = {
                        this.state.sidebarType === "icon"
                    }
                    onChange = {
                        this.changeLeftSidebarType
                    }
                    /> <Label htmlFor = "sidebarIcon" > Icon </Label> </div>
                    ...
                    <span className = "mb-2 d-block"
                    id = "radio-title" >
                    Left Sidebar Color </span> <Input type = "radio"
                    id = "leftsidebarThemelight"
                    name = "leftsidebarTheme"
                    value = "light"
                    checked = {
                        this.state.sidebarTheme === "light"
                    }
                    onChange = {
                    ...
                    /> <Label htmlFor = "leftsidebarThemecolored" > Colored </Label> </div> <hr className = "mt-1" / >
                    </React.Fragment>
                ) : null
            }
            ...
            htmlFor = "checkbox_1" >
            Preloader </Label> </div> </FormGroup> </div> </div> </SimpleBar> </div> <div className = "rightbar-overlay" > </div> 
            </React.Fragment>
        );
    }
}
